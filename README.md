...
Salida: - Ha aparecido un nuevo cliente:  Carmen -> Taxi 01 yendo a recoger a Carmen -> Cliente Carmen ya recogido por el taxi 01 -> Cliente Carmen ha sido entregado en su destino por el taxi 01 -> El cliente Carmen ha pagado 35.36 al taxi 01 y le ha calificado con un total de 4 estrellas. Calificacion media del taxista: 4.00 estrellas -> Taxi 01 vuelve a estar libre.

Caso 3: Cierre del día: A las 24:00h, el sistema hace las cuentas.
Salida: Son las 00:00, el trabajo ha terminado por hoy, los taxistas se retiraran -> Todo lo que ha recaudado el taxi 08: 618.84. UNIETAXI se lleva: 123.77 y taxista: 495.07 -> Auditoría: Sacó 5 viajes al azar para revisar la calidad. -> El programa ha terminado por hoy
