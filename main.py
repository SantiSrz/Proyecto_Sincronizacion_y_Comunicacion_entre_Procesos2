...
if __name__ == "__main__":
    ...
    taxi4 = Taxi("04", "4595 SDU", 1750, 850, empresa, antecedentes_penales = True)
    taxi5 = Taxi("05", "3876 JUY", 1000, 1000, empresa, antecedentes_penales = False)
    taxi6 = Taxi("06", "1047 JQT", 750, 750, empresa, antecedentes_penales = False)
    taxi7 = Taxi("07", "1085 QUI", 1250, 1250, empresa, antecedentes_penales = False)
    taxi8 = Taxi("08", "1720 ZJR", 1500, 1500, empresa, antecedentes_penales = False)
    taxi9 = Taxi("09", "0915 RMO", 1750, 1750, empresa, antecedentes_penales = False)
    taxi10 = Taxi("010", "2986 TRQ", 2000, 2000, empresa, antecedentes_penales = False)
